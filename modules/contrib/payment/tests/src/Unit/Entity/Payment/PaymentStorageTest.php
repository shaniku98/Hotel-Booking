...
class PaymentStorageTest extends UnitTestCase {
   ...
   * The memory cache.
   *
   * @var \Drupal\Core\Cache\MemoryCache\MemoryCacheInterface|\PHPUnit_Framework_MockObject_MockObject
   */
  ...
  public function setUp() {
    ...
    $this->sut = new PaymentStorage($this->entityType, $this->database, $this->entityManager, $this->cacheBackend, $this->languageManager, $this->paymentStatusManager, $this->paymentTypeManager, $this->memoryCache);
  }
  ...
  public function testCreateInstance() {
    ...
    $map = array(
      ...
      array('entity.memory_cache', ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $this->memoryCache),
    );
