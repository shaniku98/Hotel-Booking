...
class PaymentStorage extends SqlContentEntityStorage {
   ...
   */
  public function __construct(EntityTypeInterface $entity_type, Connection $database, EntityManagerInterface $entity_manager, CacheBackendInterface $cache, LanguageManagerInterface $language_manager, PaymentStatusManagerInterface $payment_status_manager, PaymentTypeManagerInterface $payment_type_manager, MemoryCacheInterface $memory_cache = NULL) {
  ...
  public static function createInstance(ContainerInterface $container, EntityTypeInterface $entity_type) {
    return new static($entity_type, $container->get('database'), $container->get('entity.manager'), $container->get('cache.entity'), $container->get('language_manager'), $container->get('plugin.manager.payment.status'), $container->get('plugin.manager.payment.type'), $container->get('entity.memory_cache'));
  }
